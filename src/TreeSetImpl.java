...
public class TreeSetImpl<E> {
    ...
    public static void main(String... arg) {
        final TreeSetImpl<Integer> treeSet = new TreeSetImpl<Integer>();
        ...
        final Iterator<Integer> titerator = treeSet.iterator();
        ...
        final Iterator<Integer> revitr = treeSet.descendingIterator();
